...
insert_text = """What is Brute Force? 

A simple method of problem-solving that entails exploring every alternative until the right one is found. 

Specifically for breaking passwords or encryption. 

Systematically trying to guess a password with every accessible character combination. 


Weaknesses

Slow and use a lot of resources. 

Becomes difficult for longer and more complex passwords; performance drops when passwords are getting more complex. 
...
Use protection mechanisms such as Two-Factor Authentication (2FA), Security Key or Hardware Token and CAPTCHA tests.
"""
